...
If on March 7 someone in Texas books a flight, the flight details is March 11 on Monday at 7:00 AM local time, and we store this as 12:00 PM UTC (Texas being five hours behind UTC), that seems logical. However, on March 10 Daylight Saving Time starts and now Texas is 6 hours behind UTC!
...
| --- | --- | --- | --- |
| 1 | TX1234 | 2024-03-11 12:00:00 | America/Chicago |
...
```json
{
    "_id": 1,
    "flightNumber": "TX1234",
    "departureTimeUTC": ISODate("2024-03-11T12:00:00Z"),
